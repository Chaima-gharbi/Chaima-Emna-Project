 ...
 */
final class Version20210129111302 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE emprunte ADD date_emprunte DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE emprunte DROP date_emprunte');
    }
}
