 ...
 */
final class Version20210131142319 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE livre_emprunte (livre_id INT NOT NULL, emprunte_id INT NOT NULL, INDEX IDX_9B909BF537D925CB (livre_id), INDEX IDX_9B909BF565CF9DD4 (emprunte_id), PRIMARY KEY(livre_id, emprunte_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
