 ...
 */
final class Version20210129133159 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE emprunte (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, date_retour DATE NOT NULL, date_emprunte DATE NOT NULL, INDEX IDX_F75B7D5CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
