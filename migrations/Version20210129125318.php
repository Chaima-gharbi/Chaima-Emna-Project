 ...
 */
final class Version20210129125318 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE emprunte (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, date_retour DATE NOT NULL, date_emprunte DATE NOT NULL, INDEX IDX_F75B7D5C67B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE emprunte ADD CONSTRAINT FK_F75B7D5C67B3B43D FOREIGN KEY (users_id) REFERENCES user (id)');
