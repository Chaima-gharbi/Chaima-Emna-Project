...
class AcceuilController extends AbstractController
{
    ...
    { $nbAuteurs= count($this->getDoctrine()->getRepository(Auteur::class)->findAll());
        ...
        return $this->render('acceuil/index.html.twig', ['titre'=>'Acceuil','soustitre'=>'','lien'=>$this->generateUrl('acceuil'),'nbAuteurs'=>$nbAuteurs,'nbLivres'=>$nbLivres,'nbEditeurs'=>$nbEditeurs,'nbCategories'=>$nbCategories,
